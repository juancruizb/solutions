...
class SDPAuth:
    ...
    def get_access_token(client_id: str, client_secret: str) -> str:
        ...
        Automatically refreshes if the stored token is expired or missing.
        """
        tokens = SDPAuth.load_tokens()
        refresh_token = tokens.get("refresh_token", os.getenv("SDP_REFRESH_TOKEN"))
        ...
        # Always refresh (SDP Cloud tokens expire in ~1 hour; can add expiry check here)
